...
This web app to simulate the Monty Hall game. User can enter number of simulations and choose whether to change the door, then results of the simulated games will shown in tabular format.
